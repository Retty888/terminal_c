...
- **Колёсико мыши** – масштабирует оси: на основном графике изменяются обе оси, на графике объёмов — только ось Y. Перетаскивание
  левой кнопкой мыши сдвигает график по времени.
